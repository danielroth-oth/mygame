...
const QUEST_ITEM : PackedScene = preload("res://GUI/Pause Menu/quests/quest_item.tscn")
const QUEST_STEP_ITEM : PackedScene = preload("res://GUI/Pause Menu/quests/quest_step_item.tscn")
